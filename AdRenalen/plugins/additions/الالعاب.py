...
GAME_MESSAGE = "⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝑳𝐈𝐕𝐄𝐀⌯\n\n★¦ مرحبا بك عزيزي:\n★¦في قسم العاب سورس اوليفيا\n\n ⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝑳𝐈𝐕𝐄𝐀⌯"
GAME_BUTTONS = [
    [ 
        InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
        InlineKeyboardButton ('⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝑳𝐈𝐕𝐄𝐀⌯', callback_data= 'GAME2'),
        ],[
        InlineKeyboardButton ('⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝑳𝐈𝐕𝐄𝐀⌯', url =f"https://t.me/SOURCEOLIVEA")              
                 ],[
...
async def callback_query(client, CallbackQuery):
          if CallbackQuery.data == "GAME1":
             ...
             GAME1_MESSAGE = "⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝑳𝐈𝐕𝐄𝐀⌯\n\nمرحبا بك في قسم العاب سورس اوليفيا 3D\n\n⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝑳𝐈𝐕𝐄𝐀⌯"
             ...
             await CallbackQuery.edit_message_text( 
               ...
               RETURN_GAME = "⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝑳𝐈𝐕𝐄𝐀⌯\n\n★¦مرحبا بك في قسم العاب سورس اوليفيا\n★¦اختار ما تشاء من الالعاب مسليه وستمتع بها\n\n⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝑳𝐈𝐕𝐄𝐀⌯" 

               RETURN_BUTTON = [
                    [ 
                      InlineKeyboardButton ('★¦العاب 3D', callback_data= 'GAME1'),
                      InlineKeyboardButton ('★¦العاب اوليفيا', callback_data= 'GAME2')
                      ],[
        InlineKeyboardButton ('⌯𝐒𝐎𝐔𝐑𝐂𝐄 𝐎𝑳𝐈𝐕𝐄𝐀⌯', url =f"https://t.me/SOURCEOLIVEA")              
                 ],[
                InlineKeyboardButton(
