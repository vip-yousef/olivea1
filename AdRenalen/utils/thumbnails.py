...
async def get_thumb(videoid):
    try:
        ...
        if 1 == 1:
            ...
            polygon = Image.open("AdRenalen/AdRenalen_Playng.png")
            ...
            # fonts
            font1 = ImageFont.truetype("AdRenalen/font2.ttf", 30)
            font2 = ImageFont.truetype("AdRenalen/font2.ttf", 70)
            font3 = ImageFont.truetype("AdRenalen/font2.ttf", 40)
            font4 = ImageFont.truetype("AdRenalen/font2.ttf", 35)

            image4 = ImageDraw.Draw(image2)
            image4.text(
                (10, 10), "AdRenalen MUSIC ", fill="white", font=font1, align="left"
            )
            image4.text(
                (670, 150),
                "AdRenalen MUSIC",
